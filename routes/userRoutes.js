...
router.post('/profile/:id', upload.fields([ { name: 'profile-pic', maxCount: 1 }, { name: 'docs', maxCount: 5 } ]), auth, userController.profile);
router.get('/:id', auth, userController.getuserById);
router.put('/:id', auth, upload.none(), userController.updateUser);
